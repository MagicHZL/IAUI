...
class GroupView: UIView { 
  ...
  func creatUI(){ 
    ...
    cardview_lthw0.backgroundColor = UIColor.init(red: 0.7504812047101449, green: 0.211156844656804, blue: 0.1741207917025672, alpha: 1.0) 
    //cardview_lthw0.theme_backgroundColor = "newColors.#BF362C" 
